  ...
  $.extend($.summernote.plugins, {
    imageList: function (context) {
      ...
      var defaultImageListOptions = {
        title: "Image List",
        tooltip: "Image List",
        buttonHtml: '<i class="fa fa-file-image:before{content:"\f1c5"></i>',
        spinnerHtml:
      ...
      var imageListOptions =
        typeof options.imageList === "undefined" ? {} : options.imageList;
      ...
      this.showDialog = function () {
        return $.Deferred(function (deferred) {
          ui.onDialogShown(self.$dialog, function () {
            ...
            $.get(imageListOptions.endpoint, null, null, "json").done(function (
              data
            ) {
              var content = [];
              ...
              for (var i = 0; i < data.length; i++) {
                ...
                if (i + 1 > 0 && (i + 1) % 2 === 0)
                  content.push('<div class="clearfix visible-xs-block"></div>');
                if (i + 1 > 0 && (i + 1) % 3 === 0)
                  content.push('<div class="clearfix visible-sm-block"></div>');
                if (i + 1 > 0 && (i + 1) % 4 === 0)
                  content.push(
              ...
              self.$dialog
                .find(".image-list-content")
                .html('<div class="row">' + content.join("") + "</div>");
      ...
      this.insertImage = function (filename, fullUrl) {
        ...
        context.invoke(
          "editor.insertNode",
          $('<img src="' + fullUrl + '" data-filename="' + filename + '">')[0]
        );
      };
      this.show = function () {
